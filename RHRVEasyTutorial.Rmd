...
the files of each of these databases are
...
use of the `nJobs` to use several cores and parallelize the computations.
...
a different correction method, but the `RHRVEasyStats` function. The confidence
